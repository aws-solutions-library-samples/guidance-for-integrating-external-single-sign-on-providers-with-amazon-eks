...
* Use the Terraform outputs to login into the Amazon EKS Cluster using Okta SSO.
* Check your access to Amazon EKS Cluster using `kubectl` commands.
...
To tear down all the provisioned resources, run the Terraform destroy command from the same directory it was applied.
